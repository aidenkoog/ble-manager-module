 ...
 * @returns 
 */
export const convertByteArrayToBinaryString = (value: any) => {
    let result = ""
    for (let i = 0; i < 8; i++) {
 ...
 * @returns {number}
 */
export const convertByteArrayToNumeric = (value: any) => {
    let result = 0
 ...
 * @returns 
 */
// export const convertStringToByteArray = (value: string) => {
 ...
 * @returns 
 */
// export const convertStringToByteArrayWithCount = (value: string, length: number) => {
//     const result = new ArrayBuffer(length) as any
//     for (let i = 0; i < value.length; i++) {
 ...
 * @returns 
 */
export const convertByteArrayToString = (value: any) => {
 ...
 * @returns 
 */
export const convertLongToByteArray = (value: any) => {
 ...
 * @returns 
 */
export const convertIntToBytes = (value: number) => {
...
export const convertIntToOneByte = (value: number) => {
    let array = new Int8Array(1)
    array[0] = value
    return array
}

export function hexToBytes2(hex: string) {
    for (var bytes = [], c = 0; c < hex.length; c += 2)
        bytes.push(parseInt(hex.substr(c, 2), 16));
    return bytes;
}

export function bytesToHex2(bytes: any) {
 ...
 * @returns {number}
 */
export const convertHexStringToDecimal = (hex: string) => {
 ...
 * @returns {string}
 */
export const convertBleCustomToHexData = (customData: any) => {
    let hexStringData = ""
 ...
 * @returns {any}
 */
export const byteArrayToWordArray = (data: any) => {
    var result: number[] = [], i
 ...
 * @returns {bytes}
 */
export const convertWordToByteArray = (word: number, length: number) => {
    var result = [], i,
        xFF = 0xFF
    if (length > 0)
        result.push(word >>> 24)
 ...
 * @returns {any}
 */
export function wordToByteArray(wordArray: any) {
 ...
 * @returns 
 */
export const convertDecimalToHexString = (decimalData: number) => {
    if (decimalData < 0) {
 ...
 * @returns {string}
 */
export const getFeatureNameAsUuid = (uuid: string) => {
    switch (uuid) {
